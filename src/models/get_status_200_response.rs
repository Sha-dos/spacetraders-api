...
impl GetStatus200Response {
    pub fn new(
        ...
        reset_date: String,
        description: String,
        stats: models::GetStatus200ResponseStats,
        leaderboards: models::GetStatus200ResponseLeaderboards,
        server_resets: models::GetStatus200ResponseServerResets,
        announcements: Vec<models::GetStatus200ResponseAnnouncementsInner>,
        links: Vec<models::GetStatus200ResponseLinksInner>,
